...
var standardProperty = (options = defaultPropertyDeclaration2, target, context) => {
  ...
  if (DEV_MODE3 && metadata == null) {
    issueWarning3("missing-class-metadata", `The class ${target} is missing decorator metadata. This could mean that you're using a compiler that supports decorators but doesn't support decorator metadata, such as TypeScript 5.1. Please update your compiler.`);
  }
...
var b = (i) => typeof i.startManagingContentDirection < "u" || i.tagName === "SP-THEME";
function v(i) {
  class c extends i {
    /**
     * @private
    ...
    hasVisibleFocusInTree() {
      const n = ((a = document) => {
        ...
        const s = t ? [t] : [];
        for (; t; ) {
          const o2 = t.assignedSlot || t.parentElement || t.getRootNode()?.host;
          o2 && s.push(o2), t = o2;
        }
        return s;
      })(
...
var _C = class _C extends v(LitElement) {
};
_C.VERSION = o;
var C = _C;
if (true) {
  ...
  window.__swc = {
    ...
    warn: (r, e, n, { type: a = "api", level: t = "default", issues: s } = {}) => {
      const { localName: o2 = "base" } = r || {}, u2 = `${o2}:${a}:${t}`;
      if (!window.__swc.verbose && window.__swc.issuedWarnings.has(u2) || window.__swc.ignoreWarningLocalNames[o2] || window.__swc.ignoreWarningTypes[a] || window.__swc.ignoreWarningLevels[t])
        return;
      window.__swc.issuedWarnings.add(u2);
      let m = "";
      s && s.length && (s.unshift(""), m = s.join(`
    - `) + `
`);
      const w = t === "deprecation" ? "DEPRECATION NOTICE: " : "", h2 = r ? `
...
var _2 = (r, e, i, n) => {
  for (var s = u(e, i), o2 = r.length - 1, t; o2 >= 0; o2--)
    (t = r[o2]) && (s = t(e, i, s) || s);
  return s && h(e, i, s), s;
};
function d2(r, {
  ...
  const _s = class _s extends r {
    ...
    set size(t) {
      const l2 = i ? null : n, c = t && t.toLocaleLowerCase(), p = e.includes(c) ? c : l2;
...
// node_modules/@spectrum-web-components/base/src/constants.dev.js
var INPUT_COMPONENT_TAGS = [
  "SP-SEARCH",
  "SP-TEXTFIELD",
  "SP-NUMBER-FIELD",
  "SP-COMBOBOX",
...
var INPUT_COMPONENT_PATTERN = new RegExp(
...
//# sourceMappingURL=chunk-XM354YEY.js.map
