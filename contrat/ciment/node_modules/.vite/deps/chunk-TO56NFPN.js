...
// node_modules/@spectrum-web-components/core/dist/components/progress-circle/ProgressCircle.types.js
var R = [
  "s",
  "m",
  "l"
...
// node_modules/@spectrum-web-components/core/dist/components/progress-circle/ProgressCircle.base.js
var c = Object.defineProperty;
var r = (a, e2, s, m2) => {
  for (var t = void 0, o4 = a.length - 1, p; o4 >= 0; o4--)
    (p = a[o4]) && (t = p(e2, s, t) || t);
  return t && c(e2, s, t), t;
};
var i = class extends d(C, {
  ...
  constructor() {
    super(...arguments), this.indeterminate = false, this.label = "", this.progress = 0;
  }
  makeRotation(e2) {
    return this.indeterminate ? void 0 : `transform: rotate(${e2}deg);`;
  }
  handleSlotchange() {
    const e2 = o2(this.label, this.slotEl);
    e2 && (this.label = e2);
  }
  firstUpdated(e2) {
...
var ProgressCircle = class extends i {
  // ──────────────────────────────
  //     RENDERING & STYLING
  // ──────────────────────────────
  static get styles() {
