...
class Supplier(models.Model):
    ...
    type_organisation = models.CharField(max_length=50, choices=TYPE_ORGANISATION_CHOICES, verbose_name="Type d'organisation (SA,SARL,…..)")
    ...
    bic_swift = models.CharField(max_length=11, blank=True, null=True, verbose_name="BICCODE/SWIFT (mandatory for Foreign Suppliers)")
